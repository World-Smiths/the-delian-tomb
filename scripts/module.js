(() => {
    const adventureName = "The Delian Tomb";
    const moduleName = "the-delian-tomb-module";
     ...
     *   const creaturePacks = [];
     */
    const creaturePacks = ["the-delian-tomb-module.actors"];
    /**
     ...
     *   const playlistPacks = [];
     */
    const playlistPacks = ["the-delian-tomb-module.playlists"];
    /**
