...
const id = "the-delian-tomb";
const title = "The Delian Tomb";
const tourTitle = "Importing a World adventure";
const tourDescription = "This Tour will guide you through importing World Smiths's content.";
